...
* [Docker Engine](https://docs.docker.com/get-docker/). A minimum of 4GB of memory must be allocated to each Docker node.
* [Docker Compose](https://docs.docker.com/compose/install/)
* [Git client](https://desktop.github.com/)

## Install SigNoz on Docker Swarm[](#install-signoz-on-docker-swarm "Direct link to Install SigNoz on Docker Swarm")
...
```
3. _(Optional)_ You can use the `docker swarm join` command to add more nodes to the swarm. Note that the node you added in the previous step is the manager. For details, see the [Docker Swarm Join](https://docs.docker.com/engine/reference/commandline/swarm%5Fjoin/) page of the Docker documentation.
...
<Info>
  ...
  For more details, refer to [https://signoz.io/docs/userguide/retention-period](https://signoz.io/docs/userguide/retention-period).
</Info>
